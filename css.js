...
darkicons.star = imgsvg + "<svg xmlns='http://www.w3.org/2000/svg' width='43' height='41'><head xmlns=''/><head xmlns=''/><g fill='none' fill-rule='evenodd'><path fill='" + settings.color.gold.min + "' fill-rule='nonzero' stroke='" + settings.color.bg.range[0] + "' stroke-width='4' d='M9.58 26.05l-5.47-5.538c-2.557-2.588-1.129-6.986 2.461-7.574l7.666-1.256 3.56-6.924c1.668-3.242 6.298-3.242 7.965 0l3.56 6.924 7.666 1.256c3.59.588 5.018 4.986 2.462 7.574l-5.47 5.538 1.179 7.706c.55 3.6-3.192 6.322-6.444 4.681l-6.935-3.5-6.936 3.5c-3.251 1.641-6.994-1.08-6.443-4.68L9.58 26.05z'/><path fill='" + settings.color.gold.max + "' d='M19.499 8.86c.172-.538.654-.983 1.22-.983.72 0 1.06.582 1.06 1.3v13.125L8.907 18.36c-.507-.155-1.145-.684-1.191-1.21-.063-.716.475-1.016 1.19-1.08l7.933-1.098 2.66-6.111z'/></g></svg>";
...
// dot in graphs of progress quiz
darkicons.chartdot = imgsvg + "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 10' width='20' height='10'><head xmlns=''/><head xmlns=''/><head xmlns=''/><defs><radialGradient id='g' cx='50%' cy='50%' r='50%' fx='50%' fy='50%'><stop offset='0%' stop-color='" + settings.color.bg.range[4] + "'/><stop offset='100%' stop-opacity='0' stop-color='" + settings.color.bg.range[4] + "'/></radialGradient></defs><circle cx='10' cy='5' r='4' fill='url(%23g)'/><script xmlns=''/></svg>";
...
darkicons.keyboard = imgsvg + "<svg xmlns='http://www.w3.org/2000/svg' width='27' height='19' viewBox='0 0 27 19' version='1.1'><head xmlns=''/><head xmlns=''/><head xmlns=''/><title>Group 8</title><g stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'><g><g><g><g transform='translate(2 2)'><rect stroke='" + settings.color.text.range[0] + "' stroke-width='2' x='-1' y='-1' width='25' height='17' rx='1.28'/><rect fill='" + settings.color.text.range[0] + "' x='6' y='10' width='11' height='3' rx='1'/><path d='M3 6h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zM3 10h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1zM7 6h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zM11 6h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zM15 6h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1z' fill='" + settings.color.text.range[0] + "'/><rect fill='" + settings.color.text.range[0] + "' x='18' y='6' width='3' height='3' rx='1'/><rect fill='" + settings.color.text.range[0] + "' x='18' y='10' width='3' height='3' rx='1'/><path d='M3 2h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zM7 2h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zM11 2h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zM15 2h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z' fill='" + settings.color.text.range[0] + "'/><rect fill='" + settings.color.text.range[0] + "' x='18' y='2' width='3' height='3' rx='1'/></g></g></g></g></g></svg>";

darkicons.dot = imgsvg + "<svg height='5' width='5' viewBox='0 0 5 5' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><rect fill='" + settings.color.text.range[0] + "' x='2' y='0' width='1' height='5'></rect><rect fill='" + settings.color.text.range[0] + "' x='0' y='2' width='5' height='1'></rect></svg>";
...
darkicons.correct = {};
darkicons.correct.discussion = imgsvg + "<svg xmlns='http://www.w3.org/2000/svg' width='19' height='21' viewBox='0 0 19 21' version='1.1'><head xmlns=''/><head xmlns=''/><head xmlns=''/><g stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'><g stroke='" + settings.color.correct.range[0] + "' stroke-width='2'><g><path d='M13.627 14.853v4.207l-1.076-.082a4.686 4.686 0 0 1-4.006-2.972C4.339 15.696 1 12.482 1 8.516 1 4.34 4.697 1 9.21 1c4.514 0 8.211 3.34 8.211 7.515 0 2.615-1.467 4.979-3.794 6.338z'/></g></g></g></svg>";

darkicons.correct.report = imgsvg + "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='20' viewBox='0 0 16 20' version='1.1'><head xmlns=''/><head xmlns=''/><head xmlns=''/><g stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'><g stroke-width='2' stroke='" + settings.color.correct.range[0] + "'><g><g><path d='M1 1.45v17.1' stroke-linecap='square'/><path d='M9 1H1v8h7v3h7V4H9V1z'/></g></g></g></g></svg>";
...
darkicons.stories = {};
darkicons.stories.logo = imgsvg + "<svg xmlns='http://www.w3.org/2000/svg' width='555.549' height='79.275'><head xmlns=''/><head xmlns=''/><g fill='" + settings.color.duoblue.range[0] + "'><g><path d='M42.105 38.76v.36A21.064 21.064 0 1 1 31.52 20.859V0h10.585zm-9.686.36a11.371 11.371 0 1 0-11.37 11.372A11.384 11.384 0 0 0 32.42 39.12zm52.075-20.891v23.638c0 10.424-7.324 18.307-18.467 18.307-11.463 0-18.229-7.561-18.229-18.307V18.229h10.509v23.959c0 2.307.795 7.8 7.721 7.8a7.611 7.611 0 0 0 7.959-7.8V18.229zm47.783 20.455a21.489 21.489 0 0 1-21.488 21.49h-.021a21.231 21.231 0 0 1-2.152-.109 21.488 21.488 0 0 1 .586-42.807 22.122 22.122 0 0 1 1.57-.064h.02a21.481 21.481 0 0 1 21.485 21.49zm-9.678 0a11.816 11.816 0 0 0-9.75-11.616 8.971 8.971 0 0 0-2.1-.246 9.347 9.347 0 0 0-2.189.269 11.8 11.8 0 0 0-.053 23.176 9.551 9.551 0 0 0 2.242.275 9.408 9.408 0 0 0 2.146-.25 11.82 11.82 0 0 0 9.705-11.606zM136.8 59.221V0h10.508v59.221zm16.9-52.67a6.55 6.55 0 1 1 6.549 6.551 6.55 6.55 0 0 1-6.549-6.551zm1.338 52.67V18.229h10.508v40.992zM208.291 35.5v23.721h-10.508V35.264c0-2.307-.795-7.8-7.721-7.8a7.565 7.565 0 0 0-7.959 7.8v23.957H171.6V35.5c0-10.427 7.322-18.309 18.467-18.309 11.454.002 18.22 7.565 18.224 18.309zm46.902 2.988c0 .091.006.182.006.271v18.387c0 13.611-8.117 22.129-21.25 22.129-9.873 0-18.311-5.652-19.9-14.328h11.463c1.352 3.266 5.572 4.537 8.438 4.537 7.4 0 10.746-4.854 10.746-12.176v-.844a21.052 21.052 0 1 1 10.5-18.219c.004.082.004.166-.003.243zm-9.674-.242a11.372 11.372 0 1 0-11.373 11.369 11.385 11.385 0 0 0 11.374-11.369zm57.553.438a21.489 21.489 0 0 1-21.488 21.49h-.016a21.26 21.26 0 0 1-2.158-.109 21.488 21.488 0 0 1 .59-42.807 22.122 22.122 0 0 1 1.57-.064h.014a21.482 21.482 0 0 1 21.488 21.49zm-9.678 0a11.816 11.816 0 0 0-9.75-11.616 8.971 8.971 0 0 0-2.1-.246 9.347 9.347 0 0 0-2.189.269 11.8 11.8 0 0 0-.053 23.176 9.551 9.551 0 0 0 2.242.275 9.408 9.408 0 0 0 2.146-.25 11.82 11.82 0 0 0 9.705-11.606z'/></g><g><path d='M359.053 46.885c0 8.172-6.98 13.326-16.734 13.326-9.916 0-17.135-5.312-18.246-13.957h6.822c.871 4.756 5.553 7.691 11.424 7.691 6.346 0 10.23-3.092 10.23-6.664 0-2.854-1.111-5-11.105-6.344-9.916-1.426-15.945-3.807-15.945-11.5 0-5.869 5.078-12.136 16.023-12.136 9.438 0 15.787 4.759 16.658 12.771h-6.822c-.953-4.361-4.84-6.583-9.836-6.583-5.395 0-9.281 2.538-9.281 5.712 0 2.937 2.3 3.965 10.313 5.235 9.04 1.429 16.499 3.175 16.499 12.449zM383.725 53v6.186c-9.518 1.111-16.1-4.521-16.1-14.912v-19.51h-5.555v-6.426h5.553V9.611h6.66v8.727h9.281v6.426h-9.281v19.511c0 7.217 4.444 9.043 9.442 8.725z'/><path d='M429.684 38.762A21.457 21.457 0 1 1 408.227 17.3a21.456 21.456 0 0 1 21.457 21.462zm-6.764 0a14.723 14.723 0 1 0-7.879 13 14.711 14.711 0 0 0 7.879-12.996zm32.361-21.145v6.268c-7.854-.716-12.852 3.09-12.852 10.945v24.432h-6.66V34.988c.001-12.373 8.807-18.641 19.512-17.371zM460.369 5.2a4.865 4.865 0 1 1 4.865 4.865 4.865 4.865 0 0 1-4.865-4.865zm1.5 54.146V18.531h6.731V59.35z'/><path d='M460.368 5.2a4.866 4.866 0 1 1 4.865 4.865 4.866 4.866 0 0 1-4.865-4.865zm1.5 54.146V18.425h6.732V59.35zm46.489-12.817h7.164c-2.865 8.752-9.867 13.688-19.34 13.688-11.779 0-21.014-9.395-21.014-21.412 0-11.859 9.234-21.57 20.615-21.57 10.59 0 20.777 8.756 20.7 23.322h-34.466c.877 8.518 7.4 13.531 14.168 13.531 5.81 0 9.949-2.788 12.173-7.559zm-25.939-12.021H509c-1.674-6.688-7.246-11.144-13.215-11.144-5.65 0-11.617 4.136-13.367 11.144zm73.131 12.377c0 8.172-6.98 13.326-16.736 13.326-9.916 0-17.135-5.312-18.244-13.957h6.822c.871 4.756 5.551 7.691 11.422 7.691 6.346 0 10.232-3.092 10.232-6.664 0-2.854-1.113-5-11.105-6.344-9.916-1.426-15.945-3.807-15.945-11.5 0-5.869 5.078-12.136 16.021-12.136 9.439 0 15.787 4.759 16.658 12.771h-6.822c-.951-4.361-4.84-6.583-9.836-6.583-5.393 0-9.279 2.538-9.279 5.712 0 2.937 2.3 3.965 10.313 5.235 9.04 1.429 16.499 3.175 16.499 12.449z'/></g></g></svg>";
...
// brightness overlay (added by extension)
d + '#brightness' +
...
'html' + ref + // document element
'{background:' + pc.bg.main + '}' +

// general svg containing many icons
d + '.cCL9P' +
...
// ##### modify display ############################################
	...
	// remove html bg bar on top
//d + 'div[id=root]' +
//'{margin-top: -40px}' +

	// replace html bar with div padding
//d + '.LFfrA._3MLiB' +
//'{padding-top: 40px}' +
...
'{background:' + pc.bg.main + ';border: 2px solid ' + pc.bg.secondary + ';}' +
...
'{color:' + pc.text.lightest + '}' +
	...
	// underline text
d + '.uWoNt,' + // active tab
d + '._2QyU5[data-test]:hover' + // hover tab
'{border-bottom: 3px solid ' + pc.text.lightest + '}' +
	...
	// ---- icons -------------------------------------------------
		...
		'{background:' + pc.text.lightest + '}' +
			...
			// icon (text)
		d + '._2XSRN img' +
		'{background-image: url("' + darkicons.plus + '");' +
		'background-repeat: no-repeat;padding: 50px 0 0 0;overflow: hidden;}' +
	...
	'{background:' + pc.bg.main + '}' +
		...
		// dropdown icon
	d + '._2HujR:after' +
	'{border-bottom: 10px solid ' + pc.bg.secondary + '}' +
	
		// border
	d + '._1ZY-H' +
	'{border: 2px solid ' + pc.bg.secondary + '}' +
...
'{fill:' + pc.bg.secondary + ';stroke:' + pc.bg.main + ';}' +
				...
				// full ring
d + '._3Ttma svg circle[fill="#ff9600"]' +
'{fill:' + pc.gold.dark + ';stroke:' + pc.bg.main + ';}' +

				// partial ring
					// empty part
d + '._3Ttma svg path[fill="#e2e2e2"]' +
'{fill:' + pc.bg.secondary + ';stroke:' + pc.bg.main + ';}' +

					// completed part
d + '._3Ttma svg path[fill*="https://www.duolingo.com"]' +
'{fill:' + pc.gold.dark + ';stroke:' + pc.bg.main + ';}' +
...
'{border-bottom: 2px solid ' + pc.text.main + '}' +
			...
			// top
d + '._3g-KB' +
'{border-bottom-color:' + pc.text.main + '}' +

			// selected and hover
d + '._3AGnv>._3g-KB,' + // selected
d + '._12amQ:hover>._3g-KB' + // hover
'{border-bottom-color:' + pc.duoblue.main + '}' +
...
// ##### exercises #################################################
	...
	'{background:' + pc.bg.main + '}' +
		...
		// border color
	d + '._2-1wu [data-test="challenge-text-input"],' +
	d + '._2-1wu [data-test="challenge-translate-input"]' +
	'{border-color: ' + pc.bg.secondary + '}' +
...
d + '._3uFh7,' +
d + '._3uFh7 ._1l6NK' +
'{background:' + pc.correct.dark + ';color:' + pc.correct.light + '}' +
...
d + '.t55Fx' +
'{color:' + pc.correct.light + '}' +

			// report and dicussion buttons
				// text
d + '._2MvwP' +
'{color:' + pc.correct.light + '}' +
				...
				// discussion icon
d + '._3uFh7 ._22You' +
'{background-image: url("' + darkicons.correct.discussion + '");}' +

				// report icon
d + '._3uFh7 .T9F1i' +
'{background-image: url("' + darkicons.correct.report + '");}' +
...
'{color:' + pc.text.main + '}' +
	...
	// icon
d + '.F9gdY' +
'{background-image: url("' + darkicons.keyboard + '");}' +
	
// exercises
	// words underlined with dots
d + '._10knO' +
'{background: url("' + darkicons.dot + '") repeat-x 0 100%}' +
...
'{color:' + pc.text.main + '}' +
	...
	// comment field
d + '._2yvtl' +
'{background:' + pc.bg.main + ';color:' + pc.text.main + ';border: 2px solid ' + pc.bg.secondary + ';}' +
...
d + '.Y_Qu5:focus,' +
d + '.Y_Qu5:hover' +
'{border-bottom: 2px solid ' + pc.text.lightest + '}' +
...
d + '._3SMEv,' + // all topics (full page)
d + '._3-xVp,' + // all topics (mobile page)
...
'{border-bottom: 2px solid ' + pc.text.main + '}' +
	...
	// search box
d + 'input._10HmK' +
'{background:' + pc.bg.secondary + ';color:' + pc.text.lightest + ';border: 2px solid ' + pc.bg.dark + ';}' +
...
'{background:' + pc.bg.main + ' !important;border-style:solid;border-color:' + pc.bg.dark +';}' +
		...
		// active subforum bg hover
d + '.K4oWn ._7SUuD:hover' +
'{background:' + pc.bg.main + '}' +

		// hover subforum bg
d + '.slg8x:hover,' +
d + '._22L18:hover,' + // smaller site windowed version hover bar
d + '.aZsMY:hover' + // smaller site windowed version hover text
'{background:' + pc.duoblue.main + '}' +
...
'{background:' + pc.duoblue.dark + ' !important;color:' + pc.text.lightest + ' !important}' +
	...
	// smaller site windowed "select topic"
d + '._2hVK8' +
'{color:' + pc.text.lightest + '}' +
...
d + '._13Bfz button' +
'{background:' + pc.duoblue.darkest + ' !important;border-color:' +
pc.duoblue.main + ' !important;color:' + pc.duoblue.main + ' !important;}' +
...
// ##### splash page ###############################################
	// background
d + '.splash-page .container' +
'{background:' + pc.bg.main + '}' +

	// text
d + '.splash-page .container .body' +
'{color:' + pc.text.main + '}' +

	// stories logo
d + '.splash-page .container .duolingo-stories' +
'{background-image: url("' + darkicons.stories.logo + '") !important;}' +

	// language box
		// background
	d + '.splash-page .container .courses .course-group .course' +
	'{background:' + pc.duoblue.darkest + ';border-color: ' + pc.duoblue.main + ';}' +
	
		// text
	d + '.splash-page .container .courses .course-group .course .title' +
	'{color:' + pc.text.lightest + '}' +
...
// ##### main page #################################################
	...
	// text
d + '.home-page .story-grid .description h2,' + // title
d + '.home-page .story-grid .description p,' + // explanation
d + '.set-header,' + // set title
d + '.home-page .story-grid .story .title,' + // story title
d + '.home-page .story-grid .story .parts,' + // story part
d + '.completed-all-sets-notification h2,' + // all sets completed title
d + '.completed-all-sets-notification p' + // completed check back later text
'{color:' + pc.text.main + '}' +

	// set split
d + '.home-page .set::before' +
'{background:' + pc.bg.secondary + '}' +
	...
	'{background-image: url("' + darkicons.star + '");}' +
		...
		// reading owl
	//d + '.home-page .story-grid .reading-duo' +
...
// ##### story page ################################################
	...
	// text
d + '.synced-text.highlighted,' + // title
d + '.synced-text,' +
...
'{background:' + pc.duoblue.main + ';box-shadow: 0 0 14px 14px ' + pc.duoblue.main + ';}' +
	...
	// progress bar
d + '.story-header .progress-bar' +
'{background:' + pc.bg.secondary + '}' +

	// close button
d + '.story-header .close-button' +
'{' + bright + '}' +

	// questions
		// text
d + '.challenge .challenge-question' +
'{color:' + pc.text.main + '}' +

		// arrange exercise
			// unpicked
d + '.arrange-challenge .phrase-bank .phrase' +
'{background:' + pc.bg.dark + ';color:' + pc.text.light + '}' +
				
			// picked
d + '.arrange-challenge .phrase-bank .phrase.placed' +
'{background:' + pc.bg.dark + ';color:' + pc.bg.dark + ';border-color:' + pc.bg.secondary + '}' +

			// sorted
d + '.arrange-challenge .selected-phrases .arrange-phrase' +
'{background:' + pc.bg.dark + ';color:' + pc.text.light + '}' +

		// multiple choice
d + '.multiple-choice-challenge .challenge-answers li button' +
'{background:' + pc.duoblue.darkest + '}' +

		// selection
d + '.challenge-active.tap-challenge .tappable-phrase,' + // tapp active
d + '.tap-challenge .tappable-phrase,' + // tapp
d + '.challenge .selectable-token,' + // select
d + '.challenge .selectable-token.grade-neutral,' + // select
d + '.challenge.match-challenge .tokens .selectable-token,' + // match
d + '.challenge.match-challenge .tokens .selectable-token.match-grade-correct' + // match
'{background:' + pc.bg.dark + ';color:' + pc.text.light + '}' +

			// correct
d + '.challenge .selectable-token.grade-correct,' +
d + '.challenge.match-challenge .tokens .selectable-token.grade-correct' +
'{background:' + pc.correct.dark + ';color:' + pc.correct.maintext + '}' +

	// solution
		// wrong
d + '.ribbon.incorrect-ribbon' +
...
'{background:' + pc.bg.dark + ';color:' + pc.text.light + '}' +
	...
	// continue button
d + '.play-controls .continue:disabled' +
'{background:' + pc.bg.secondary + '}' +

	// scoring
		// text
d + '.story-end-ring-of-fire .xp-goal-met,' + // goal met
d + '.story-end-section .part-complete-carousel p' + // part
'{color:' + pc.text.main + '}' +
...
'{background:' + pc.bg.main + '}' +
		...
		// text
d + '.story-feedback .rating .least,' +
d + '.story-feedback .rating .most' +
'{color:' + pc.text.main + '}' +

		// score button
d + '.story-feedback .rating .buttons button' +
'{background:' + pc.bg.dark + ';color:' + pc.text.light + '}' +

		// improvement typing field
d + '.story-feedback .comment' +
'{background:' + pc.bg.dark + ';color:' + pc.text.light + '}' +
...
// padding top to replace html bar removal
//d + '.BWibf._3MLiB' +
//'{padding-top: 40px;}' +
...
// split lines
d + '.f4TL7:not(:last-child)' +
'{border-bottom: 2px solid ' + pc.bg.secondary + '}' +
...
'{background:' + pc.duoblue.darkest + ';border-color:' + pc.duoblue.main + ';}' +
	...
	// equipped
		// text
d + '._3CBye:disabled' +
'{color:' + pc.bg.secondary + '}' +

d + '._3CBye:disabled:after' +
'{background:' + pc.bg.main + ';border-color:' + pc.bg.secondary + ';}' +
...
'{border: 2px solid ' + pc.bg.dark + ';}' +
	...
	// search icon
d + '._1UnBr' +
'{background-image: url("' + darkicons.lookingglass + '")}' +
...
// background
d + '._2sFIH' +
'{background:' + pc.bg.main + ';border-color:' + pc.bg.darker + ';}' +

// text
d + '._2P32V,' + // progress quiz title
d + '.WAG_X,' + // x since last quiz
d + '._3K8Bl,' + // score history
d + '._14yn0._2sFIH h2,' + // tiers title
d + '._25mVu,' + // tier name
d + '._3l3j1,' + // score
d + '.P0ggg,' + // graph y-axis
d + '._2FwOe' + // graph x-axis
'{color:' + pc.text.main + '}' +

// chart dotted lines
d + '._33nmT:after' +
'{background-image: url("' + darkicons.chartdot + '");opacity: 1;}' +
...
sf.addcss = function(){
	var stylesheet = document.getElementById("DuolingoThemeChanger");
	// add CSS
	if(stylesheet){
		stylesheet.innerHTML = sheet.innerHTML;
	} else {
